...
// ── Filtering ──
export function filterWorkflows(workflows, statusFilter, envFilter) {
...
// ── Step Summary ──
export function summarizeSteps(compiledPlan) {
...
export function toVersionMetadata(version) {
    return {
...
export function validateConnections(connections, requestedIds) {
