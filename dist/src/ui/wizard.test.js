...
import { createWizardState, getProgressIndicator, canGoNext, canGoPrevious, canPublish, goToNextStep, goToPreviousStep, goToStep, setFieldValue, buildStepViewModel, getCurrentStep, saveWizardState, loadWizardState, clearWizardState, } from './wizard.js';
// ── Helpers ──
...
function makeTemplate(stepCount = 3) {
