...
function makeStepWithoutConnection() {
    return {
        stepIndex: 0,
        title: 'Basic Info',
...
describe('buildStepTestButtonViewModel', () => {
    ...
    it('returns visible=false and canSubmit=false for non-testable step', () => {
        const vm = buildStepTestButtonViewModel(makeStepWithoutConnection(), initialStepTestState());
...
//# sourceMappingURL=step-test.test.js.map