 ...
 */
function validateType(fieldType, value) {
    if (value === null || value === undefined)
        return null;
    switch (fieldType) {
        case 'text':
 ...
 */
export function validateStep(step, fieldValues) {
    const errors = [];
 ...
 */
export function validateAllSteps(steps, wizardState) {
    const errors = [];
 ...
 */
export function isPublishEnabled(steps, wizardState) {
