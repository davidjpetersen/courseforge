...
describe('executeHttpAction', () => {
    it('executes a successful request with context interpolation', async () => {
        ...
        expect(httpClient).toHaveBeenCalledWith('https://example.com/tenant-1', expect.objectContaining({
    ...
    it('retries 5xx responses with exponential backoff', async () => {
        ...
        const result = await executeHttpAction({ method: 'GET', url: 'https://example.com', maxRetries: 2, initialDelayMs: 10 }, {
            tenantId: 'tenant-1',
            workflowId: 'wf-1',
            traceId: 'trace-1',
            variables: {},
    ...
    it('does not retry 4xx responses', async () => {
        ...
        await expect(executeHttpAction({ method: 'GET', url: 'https://example.com', maxRetries: 3 }, {
            tenantId: 'tenant-1',
            workflowId: 'wf-1',
            traceId: 'trace-1',
            variables: {},
