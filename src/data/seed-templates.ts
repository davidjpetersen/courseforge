...
export const ROSTER_OPS_TEMPLATE: Template = {
  templateId: 'tpl-roster-sync-001',
  name: 'Automated Roster Sync',
  description:
    'Synchronizes student and staff rosters between your SIS and LMS on a configurable schedule. ' +
...
export const COURSE_LIFECYCLE_TEMPLATE: Template = {
  templateId: 'tpl-course-lifecycle-001',
  name: 'Course Lifecycle Manager',
  description:
    'Automates course creation, enrollment periods, and archival based on your academic calendar. ' +
...
export const NOTIFICATIONS_TEMPLATE: Template = {
  templateId: 'tpl-notifications-001',
  name: 'Smart Notification Dispatcher',
  description:
    'Sends targeted notifications to students, instructors, or admins based on LMS events. ' +
