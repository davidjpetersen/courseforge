...
- [x] 1. Create OneRoster property tests (P1–P5)
  - [x] 1.1 Create `packages/connectors/oneroster/index.property.test.ts` with property test for P1: Delta filter URL construction
  ...
  - [x] 1.2 Add property test for P2: Org filtering preserves only matching records
  ...
  - [x] 1.3 Add property test for P3: User batching invariants
  ...
  - [x] 1.4 Add property test for P4: Field mapping correctness
  ...
  - [x] 1.5 Add property test for P5: Error threshold behavior
...
- [x] 2. Checkpoint — Run OneRoster property tests
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Create LTI Provision property tests (P6–P7)
  - [x] 3.1 Create `packages/connectors/lti-provision/index.property.test.ts` with property test for P6: D2L signature computation
  ...
  - [x] 3.2 Add property test for P7: LMS error normalization
...
- [x] 4. Create registry tests with P8
  - [x] 4.1 Create `packages/connectors/registry.test.ts` with unit tests verifying 'oneroster' and 'lti-provision' entries exist in the registry
    - Verify `resolveConnector('oneroster')` and `resolveConnector('lti-provision')` return connector objects
    - _Requirements: 13.1, 13.2_

  - [x] 4.2 Add property test for P8: Unknown connector key error contains key
...
- [x] 5. Final checkpoint — Run all connector tests
